...
$guestbookurl = "http://www.newboston.net/harpers/guestbook.html";
$guestbookreal = "/usr/home/mena/public_html/newboston/harpers/guestbook.html";
$guestlog = "/usr/home/mena/public_html/newboston/harpers/guestlog.html";
$cgiurl = "http://www.newboston.net/cgi-bin/guestbook.pl";
...
$recipient = 'harpers@newboston.net';
...
if ($mail eq '1') {
   ...
   print MAIL "You have new mail from the newboston.net website:\n\n";
   print MAIL "------------------------------------------------------\n";
